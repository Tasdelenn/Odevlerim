...
//    [3,1,5,2]
    ...
    public static void main(String[] args) {
        ...
        int[][] list = arrayOlustur(satirSayisi,sutunSayisi);
...
//        }
    ...
    public static int[][] arrayOlustur(int satir, int sutun){
        int[][] yeniArray=new int[satir][sutun];
        for (satir = 0; satir < yeniArray.length; satir++) {
            for (sutun = 0; sutun < yeniArray[satir].length; sutun++) {
                int eleman = (int) (Math.random() * 100);
                yeniArray[satir][sutun] = eleman;
            }
        }
    ...
    public static void sutunToplami(int[][] array){
        int toplam = 0;
